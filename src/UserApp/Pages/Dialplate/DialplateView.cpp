...
#define ANIM_OPA_DEF(start_time, obj) \
    ...
    lv_coord_t h_tar_btn = lv_obj_get_height(ui.btnCont.btnTools);
    ...
    lv_anim_timeline_wrapper_t wrapper[] =
            {
                    ...
                    ANIM_DEF(500, ui.btnCont.btnMedia, height, 0, h_tar_btn),
                    //ANIM_DEF(600, ui.btnCont.btnRec, height, 0, h_tar_btn),
                    ANIM_DEF(700, ui.btnCont.btnTools, height, 0, h_tar_btn),
...
void DialplateView::TopInfo_Create(lv_obj_t* par)
{
    ...
    lv_obj_set_size(cont, LV_HOR_RES, 120);

    lv_obj_set_style_bg_opa(cont, LV_OPA_COVER, 0);
    lv_obj_set_style_bg_color(cont, lv_color_hex(0x333333), 0);//灰色
    ...
    lv_obj_set_style_text_font(label, Resource::GetFont("bahnschrift_48"), 0);
    lv_obj_set_style_text_color(label, lv_color_white(), 0);
    lv_label_set_text(label, "1111");
    lv_obj_align(label, LV_ALIGN_TOP_MID, 0, 50);
    ui.topInfo.labelTime = label;

    label = lv_label_create(cont);
    lv_obj_set_style_text_font(label, Resource::GetFont("bahnschrift_17"), 0);
    lv_obj_set_style_text_color(label, lv_color_white(), 0);
    lv_label_set_text(label, "2020/4/20");
    lv_obj_align_to(label, ui.topInfo.labelTime, LV_ALIGN_OUT_BOTTOM_MID, 0, 8);
    ui.topInfo.labelUnit = label;
}
...
void DialplateView::BottomInfo_Create(lv_obj_t* par)
{
    ...
    lv_obj_align(cont, LV_ALIGN_TOP_MID, 0, 85);
...
void DialplateView::SubInfoGrp_Create(lv_obj_t* par, SubInfo_t* info, const char* unitText)
{
    ...
    lv_obj_t* label = lv_label_create(cont);
    lv_obj_set_style_text_font(label, Resource::GetFont("bahnschrift_17"), 0);
    lv_obj_set_style_text_color(label, lv_color_white(), 0);//此处并没有设置标签值
...
void DialplateView::BtnCont_Create(lv_obj_t* par)
{
    ...
    ui.btnCont.btnMedia = Btn_Create(cont, Resource::GetImage("locate"), -55);
    //ui.btnCont.btnRec = Btn_Create(cont, ResourcePool::GetImage("start"), 0);
    ui.btnCont.btnTools = Btn_Create(cont, Resource::GetImage("menu"), 55);
}
...
lv_obj_t* DialplateView::Btn_Create(lv_obj_t* par, const void* img_src, lv_coord_t x_ofs)
{
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0x00bfff), LV_STATE_FOCUSED);
